...
export function SpendingTrendsChart() {
  ...
  return (
    <Card className="brutal-card w-full overflow-hidden pt-0 rounded-none">
      <CardHeader className="flex items-center gap-2 rounded-none space-y-0 border-b-2 border-border bg-primary/15 py-5 sm:flex-row">
